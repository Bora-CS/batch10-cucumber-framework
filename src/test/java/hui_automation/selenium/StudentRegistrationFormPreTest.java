...
//	}
	...
	private static void findRequiredValidationResult(WebDriver driver) {
		...
		String firstNameValidResultStr = firstNameValidStr.substring(firstNameValidStr.indexOf("=") + 1,
				firstNameValidStr.indexOf(","));
		...
		String lastNameValidResultStr = lastNameValidStr.substring(lastNameValidStr.indexOf("=") + 1,
				lastNameValidStr.indexOf(","));
		...
		String phoneNumberValidResultStr = phoneNumberValidStr.substring(phoneNumberValidStr.indexOf("=") + 1,
				phoneNumberValidStr.indexOf(","));
		...
		String genderValidResultStr = genderValidStr.substring(genderValidStr.indexOf("=") + 1,
				genderValidStr.indexOf(","));
	...
	private static void findValidationResult(WebDriver driver) {
		...
		String emailValidResultStr = emailValidStr.substring(emailValidStr.indexOf("=") + 1,
				emailValidStr.indexOf(","));
