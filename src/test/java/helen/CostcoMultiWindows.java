...
public class CostcoMultiWindows {
	...
	public static void main(String[] args) {
		...
		try {
			...
			helen.utilities.Keywords.checkIfElementExists(driver, By.xpath("//*[contains(text(), 'What is Costco Next?')]"), "Not on the Costco Next page");
			
			//close Costco Next window and switch back to main page
			driver.close();
			...
			helen.utilities.Keywords.checkIfElementExists(driver, By.xpath("//*[@automation-id='headerOutput']"), "Not on the 2-Day Delivery page");
			//close 2Day Delivery page
			driver.close();
