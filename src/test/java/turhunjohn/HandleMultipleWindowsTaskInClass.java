...
//			driver.navigate().to("https://costconext.com/");
//			driver.findElement(By.xpath("//a[a[@href='https://costconext.com/'][@target]")).click();
...
//			System.out.println("New Window Handle: " + newHandle);
			...
			String newSecondHandle = driver.getWindowHandle();
			System.out.println("New Second Window Handle: " + newSecondHandle);
