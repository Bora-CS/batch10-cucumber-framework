	...
	public static void main(String[] args) {
		...
		try {
			...
			if (!targetMessageExists) {
				throw new Exception("We're not on the redcross page");
			}
			...
			boolean emailFieldExists = Keywords.checkIfElementExists(driver, By.xpath("//input[@id='signInName']"));
			if (!emailFieldExists) {
				throw new Exception("Email field was expected but not found");
			}
