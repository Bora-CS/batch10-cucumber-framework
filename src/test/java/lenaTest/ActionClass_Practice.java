...
public class ActionClass_Practice {
	...
	static void checkBox() {
		WebDriver driver1 = DataDriven_Application.driverFactory();
	...
	static void draggable() {
		WebDriver driver = DataDriven_Application.driverFactory();
...
//go inside of frame
		driver.switchTo().frame(driver.findElement(By.tagName("iframe")));
		ac.clickAndHold(driver.findElement(By.xpath("//*[contains(@class,'ui-sortable-handle[0]')]"))).moveByOffset(0,80).release().build().perform();
		driver.switchTo().defaultContent();
